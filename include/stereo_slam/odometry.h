...
class Odometry {
   public:
    ...
    void SetBackend(std::shared_ptr<Optimization> optimization) { optimization_ = optimization; }
   ...
   private:
    ...
    int num_features_ = 400;
    int num_features_init_ = 80;
    int num_features_tracking_ = 60;
    int num_features_tracking_bad_ = 20;
    int num_features_needed_for_keyframe_ = 80;
